...
-- hotkeys 
theme.hotkeys_font =  "Hack Nerd Font Bold 10"
theme.hotkeys_description_font =  "Hack Nerd Font Regular 10"
theme.hotkeys_modifiers_fg = "#ffffff"
-- prompt
--theme.prompt_font = "Hack Nerd Font Regular 10"
-- 
...
theme.taglist_squares_sel = theme_assets.taglist_squares_sel(
    taglist_square_size, colors.cyan
)
theme.taglist_squares_unsel = theme_assets.taglist_squares_sel(
    taglist_square_size, colors.red
)
